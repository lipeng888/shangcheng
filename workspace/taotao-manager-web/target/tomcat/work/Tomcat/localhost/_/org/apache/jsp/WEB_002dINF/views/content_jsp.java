 ...
 * Generated at: 2017-09-11 10:38:24 UTC
...
public final class content_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("$(function(){\r\n");
      out.write("\t//id选择器，找到的就是内容分类树\r\n");
      out.write("\tvar tree = $(\"#contentCategoryTree\");\r\n");
      out.write("\t//id选择器，找到的就是datagrid\r\n");
      out.write("\tvar datagrid = $(\"#contentList\");\r\n");
      out.write("\ttree.tree({\r\n");
      out.write("\t\t//给树上所有的节点绑定点击事件\r\n");
      out.write("\t\tonClick : function(node){\r\n");
      out.write("\t\t\t//执行树的isLeaf方法，作用是判断节点是否是叶子节点，如果是叶子节点则执行以下逻辑\r\n");
      out.write("\t\t\tif(tree.tree(\"isLeaf\",node.target)){\r\n");
      out.write("\t\t\t\t//执行reload的reload方法，作用是重载datagrid数据。\r\n");
      out.write("\t\t\t\t//其实就是重启发起了一次请求，从后台获取内容数据，请求的参数是分类id\r\n");
      ...
      out.write("    \t//if(node):判断node不为空或者不是未定义\r\n");
      out.write("    \t//$(\"#contentCategoryTree\").tree(\"isLeaf\",node.target):判断节点是否是叶子节点\r\n");
      out.write("    \t//如果node为空，或者是未定义，或者不是叶子节点，执行以下逻辑\r\n");
      out.write("    \tif(!node || !$(\"#contentCategoryTree\").tree(\"isLeaf\",node.target)){\r\n");
      out.write("    \t\t$.messager.alert('提示','新增内容必须选择一个内容分类!');\r\n");
      out.write("    \t\treturn ;\r\n");
      out.write("    \t}\r\n");
      out.write("    \t//创建新的窗口，url就是创建窗口的数据\r\n");
      ...
      out.write("}];\r\n");
      out.write("\r\n");
      out.write("\tfunction createWindow(params){\r\n");
      out.write("\t\t$(\"<div>\").css({padding:\"5px\"}).window({\r\n");
      out.write("\t\t\twidth : params.width?params.width:\"80%\",\r\n");
      out.write("\t\t\theight : params.height?params.height:\"80%\",\r\n");
      out.write("\t\t\tmodal:true,\r\n");
      out.write("\t\t\ttitle : params.title?params.title:\" \",\r\n");
      out.write("\t\t\thref : params.url,\r\n");
      out.write("\t\t\tonClose : function(){\r\n");
      out.write("\t\t\t\t$(this).window(\"destroy\");\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tonLoad : function(){\r\n");
      out.write("\t\t\t\tif(params.onLoad){\r\n");
      out.write("\t\t\t\t\tparams.onLoad.call(this);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
