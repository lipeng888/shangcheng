 ...
 * Generated at: 2017-09-09 09:58:18 UTC
...
public final class item_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tfilePostName  : \"uploadFile\",   \t\t//上传图片的文件名\r\n");
      out.write("\t\tuploadJson : '/rest/pic/upload',\t\t//上传的请求路径\r\n");
      out.write("\t\tdir : \"image\" \t\t\t//上传文件类型\r\n");
      out.write("\t};\r\n");
      out.write("\t\r\n");
      out.write("\tvar itemAddEditor ;\r\n");
      out.write("\t//页面加载完成后，执行以下逻辑\r\n");
      out.write("\t$(function(){\r\n");
      out.write("\t\t//创建富文本编辑器\r\n");
      ...
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//$(\"#itemAddForm [name=price]\").val(xxx),找到提交到后台的，以分为单位的价格，赋值\r\n");
      out.write("\t\t//$(\"#itemAddForm [name=priceView]\").val()) * 100，获取以元为单位的价格，乘以100\r\n");
      out.write("\t\t//不是使用eval：\"1\"+\"1\"=\"11\"   使用eval：\"1\"+\"1\"=\"2\" \r\n");
      out.write("\t\t$(\"#itemAddForm [name=price]\").val(eval($(\"#itemAddForm [name=priceView]\").val()) * 100);\r\n");
      out.write("\t\t//执行富文本编辑器的同步方法。富文本编辑器编辑区域的内容不能提交，把数据放到可以提交的多行文本域中#itemAddForm [name=desc]\r\n");
      ...
      out.write("   \t\t\t    //在窗口打开之后执行以下逻辑\r\n");
      out.write("   \t\t\t    onOpen : function(){\r\n");
      out.write("   \t\t\t    \tvar _win = this;\r\n");
      out.write("   \t\t\t    \t//$(\"ul\")标签选择器。$(\"ul\",_win)标签选择器，_win选择器得选择范围。\r\n");
      out.write("   \t\t\t    \t//在当前打开的窗口中获取ul标签，其实就是获取上面创建的ul标签，创建EasyUI树\r\n");
      out.write("   \t\t\t    \t$(\"ul\",_win).tree({\r\n");
      out.write("   \t\t\t    \t\t//创建树需要的数据，所发起的请求\r\n");
