...
public class CloudSolrServerTest {
	...
	public void testSaveAndUpdate() throws Exception {
		...
		// 如果id唯一域不存在，执行新增操作
		// 如果id唯一域存在，执行更新操作
		doc.setField("id", "c004");
		doc.setField("item_title", "30k月薪，走上人生巅峰又近了一步，迎娶白富美");
	...
	public void testDelete() throws Exception {
		...
		// 根据唯一域（id）进行删除
		// this.cloudSolrServer.deleteById("c004");
	...
	public void testQuery() throws Exception {
		...
		QueryResponse response = this.cloudSolrServer.query(query);
